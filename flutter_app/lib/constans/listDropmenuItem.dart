...
class ListDropMenuItem {
  ...
  static void dropLichsu(){
    ...
    listlichsu.add(DropdownMenuItem(child: Text("Tất cả giao dịch"), value: "all",));
    listlichsu.add(DropdownMenuItem(child: Text("Khóa học mới"), value: "khm",));
    listlichsu.add(DropdownMenuItem(child: Text("Khóa học đã có chứng chỉ"), value: "dctc",));
    listlichsu.add(DropdownMenuItem(child: Text("Khóa học chưa có chứng chỉ"), value: "cccc",));
    listlichsu.add(DropdownMenuItem(child: Text("Đang chờ cấp chứng chỉ"), value: "dcc",));
    listlichsu.add(DropdownMenuItem(child: Text("Hủy khóa học"), value: "huy",));
  }
